...
def thunderstorm_potential(showalter_index, omega700, omega500, moisture_850,
    ...
    # Showalter Index: T500 minus the temperature of an 850-hPa parcel
    # lifted to 500 hPa. More-negative values mean stronger instability.
    ...
    score *= 0.40 + 0.60 * np.maximum(showalter, ascent)
